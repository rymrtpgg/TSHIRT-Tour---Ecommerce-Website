...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 20, 2021 at 02:36 PM
...
CREATE TABLE `category` (
  ...
  `category_total_item` varchar(255) NOT NULL,
...
CREATE TABLE `orders` (
  ...
  `order_delivery_fee` varchar(255) NOT NULL,
...
CREATE TABLE `wishlists` (
  ...
  `user_id` int(11) NOT NULL,
  `product_id` int(11) NOT NULL,
  `wishlist_price` varchar(255) NOT NULL,
  `wishlist_product_name` text NOT NULL,
  `wishlist_created_at` datetime NOT NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
